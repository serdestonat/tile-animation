  ...
  anchors.forEach((anchor) => {
    anchor.addEventListener("mouseover", function () {
      ...
      anchors.forEach((a) => {
        ...
        a.style.backgroundImage = `url(https://tutorials.wpipractice.com/wp-content/uploads/2024/10/${bgImage}.jpeg)`;
      });
    });
    ...
    anchor.addEventListener("mouseleave", function () {
      ...
      anchors.forEach((a) => {
        ...
        a.style.backgroundImage = `url(https://tutorials.wpipractice.com/wp-content/uploads/2024/10/${originalBgImage}.jpeg)`;
      });
    });
  });
});
